...
export function CredentialsTab() {
  ...
  const openEdit = (c: Credential) => {
    ...
    // host onboarding, not created here — this form has no field for them.
    // Editing one falls back to the generic "custom" shape rather than
    // crashing; nobody is expected to actually use this path for ssh_key.
    setCredType(c.credential_type === "ssh_key" ? "custom" : c.credential_type);
