          ...
          >
            <div className="flex items-center justify-between px-1">
              <span className="text-xs text-[var(--color-text-muted)]">
                ...
                {result.fallback && (
                  <span className="ml-2 px-1.5 py-0.5 rounded-sm text-[10px]" style={{ background: alpha(C.warning, 0.15), color: STATUS_TEXT.warning }}>
                    keyword fallback
                  </span>
                )}
              </span>
                        ...
                        <div className="flex items-start justify-between gap-2 mb-1">
                          ...
                          <div className="flex items-center gap-2 flex-shrink-0">
                            ...
                            <span
                              ...
                              style={{
                                background: hit.score > 0.75 ? alpha(C.online, 0.15) : "var(--color-bg-elevated)",
