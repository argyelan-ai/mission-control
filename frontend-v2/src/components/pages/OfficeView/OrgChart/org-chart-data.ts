...
export const ORG_CHART: OrgChartData = {
  nodes: [
    // ── Root ──────────────────────────────────────────────────────────────
    {
      ...
      status: "online",
      icon: User,
      tagline: "Spricht Ideen aus, das Team setzt sie um.",
      tier: "operator",
      parentId: null,
    },
    ...
    // ── Voice branch (parallel to Boss, under the operator) ──────────────
    {
      ...
      icon: Mic,
      tagline: "Sprache rein, Antwort raus — LiveKit + xAI Realtime.",
      tier: "voice",
      parentId: "mark",
    },
    ...
    // mental model is that Jarvis is the channel.
    {
      ...
      model: "opus-4.7",
      icon: Crown,
      tagline: "Verteilt Arbeit. Implementiert selbst nie.",
      tier: "lead",
      parentId: "jarvis",
    },
    ...
    // ── Workers (under Boss) ─────────────────────────────────────────────
    {
      ...
      model: "sonnet-4.6",
      icon: Code2,
      tagline: "Frontend, Backend, Skripte — der Allrounder.",
      tier: "worker",
      parentId: "boss",
    },
    {
      ...
      model: "qwen3.6-35b",
      icon: Zap,
      tagline: "Lokale Coding-Tasks, schnell und ohne Overhead.",
      tier: "worker",
      parentId: "boss",
    },
    {
      ...
      model: "sonnet-4.6",
      icon: ShieldCheck,
      tagline: "Reviewed Code, prüft Security, sagt Stop wenn nötig.",
      tier: "worker",
      parentId: "boss",
    },
    {
      ...
      model: "qwen3.6-35b",
      icon: Clapperboard,
      tagline: "Bilder & Videos — visuelle Content-Pipeline.",
      tier: "worker",
      parentId: "boss",
    },
    {
      ...
      model: "qwen3.6-35b",
      icon: PenLine,
      tagline: "Blogposts, Newsletter, Copywriting in DE & EN.",
      tier: "worker",
      parentId: "boss",
    },
    {
      ...
      model: "qwen3.6-35b",
      icon: Telescope,
      tagline: "Web-Recherche, Marktanalyse, Daten verdichten.",
      tier: "worker",
      parentId: "boss",
    },
    {
      ...
      model: "sonnet-4.6",
      icon: Rocket,
      tagline: "Bringt Code live — Vercel, Docker, CI/CD.",
      tier: "worker",
      parentId: "boss",
    },
    {
      ...
      model: "sonnet-4.6",
      icon: FlaskConical,
      tagline: "Tests, E2E, Bug-Reports — bevor der Operator sie sieht.",
      tier: "worker",
      parentId: "boss",
    },
    {
      ...
      model: "sonnet-4.6",
      icon: Wrench,
      tagline: "Installiert MCP-Server, Skills und Plugins.",
      tier: "worker",
      parentId: "boss",
    },
    {
      ...
      model: "qwen3.6-35b",
      icon: Sparkles,
      tagline: "Morgen-Briefings & geplante Routinen.",
      tier: "worker",
      parentId: "boss",
    },
  ],
