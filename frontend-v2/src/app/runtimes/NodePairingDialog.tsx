 ...
 *
 * Modal-Chrome wie HostOnboardDialog/HostFormModal — bewusst dieselbe Form,
 * kein neues Muster für einen einzigen Klick+Anzeige-Dialog.
 */
...
export function NodePairingDialog({ onClose }: { onClose: () => void }) {
