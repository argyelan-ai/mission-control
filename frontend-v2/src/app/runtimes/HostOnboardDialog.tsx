 ...
 * Modal-Chrome ist HostFormModal in DIESER Sektion nachempfunden (gleiche
 * Farben/Layout), nicht neu erfunden — bewusst funktional schlicht, das
...
export function HostOnboardDialog({ onClose }: { onClose: () => void }) {
