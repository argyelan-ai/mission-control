...
**Stand:** v0.9+ Benchmark Studio Vertical + Kern-Bausteine (ADR-069); OpenClaw Gateway Sunset complete (Phases 28-31, ADR-039 Accepted)
...
#### Kern-Bausteine fuer Publishing (ADR-065, ADR-069)
...
#### mc-playwright — Record + Compose (NEU 2026-07-11, ADR-069)
...
#### bench_studio Vertical (NEU 2026-07-11, ADR-069)
