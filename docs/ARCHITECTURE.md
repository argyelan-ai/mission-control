...
- Jarvis (host-runtime, OpenAI/xAI Realtime worker im voice-worker Container; früher "Voice", siehe ADR-038; Provider-Switch siehe ADR-060) — `voice_worker/mc_client.py:vault_*` Function-Tools, kein TOOLS.md nötig
