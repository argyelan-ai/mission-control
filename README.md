...
| Voice agent (LiveKit + realtime speech) | `LIVEKIT_*`, `XAI_API_KEY`, `JARVIS_AGENT_TOKEN`, `VOICE_API` (ADR-082, vorab `gpt-live-1` transport — see `voice_worker/Dockerfile.gpt-live`) |
