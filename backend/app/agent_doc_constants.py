...
CANONICAL_VERBS: dict[str, str] = {
    ...
    "patch": "Set status explicitly: done|review|in_progress|blocked|failed|waiting|inbox (`waiting` = park your own task without raising a blocker).",
    ...
    "approve": "Approve a review: `mc approve <task-id>` — name the author's card.",
    "reject": "Request changes: `mc reject <task-id> --feedback \"...\"` — name the author's card.",
    "review-note": "File a LATE review verdict on an already-closed card (comment + review_decision, no status change).",
    ...
    "hold": "Lead: pause a not-yet-dispatched card so it isn't claimed (--reason required).",
    "release": "Lead: undo a `mc hold`, re-opening the card for claim.",
    "reassign": "Lead: hand a card to another agent (--to name-or-uuid), no attempt-id needed.",
...
CANONICAL_VERB_SCOPES: dict[str, str | None] = {
    ...
    "approve": "tasks:write",
    "reject": "tasks:write",
    "review-note": "tasks:write",
    "finish": "tasks:write",
    "blocked": "tasks:write",
    "park": "tasks:write",
    "hold": "tasks:manage",
    "release": "tasks:manage",
    "reassign": "tasks:manage",
    "failed": "tasks:write",
    "comment": "tasks:write",
    "ask": "chat:write",
    "msg": "chat:write",
